...
const getTabDesc = (id) =>
  TABMeta[id]?.desc || "계정 및 워크스페이스 설정을 관리합니다.";
...
export default function SettingsModal({ open, onClose, user }) {
  ...
  const accountTabs = Object.entries(TABMeta).filter(
    ([, meta]) => meta.section === "Account"
  );
  const workspaceTabs = Object.entries(TABMeta).filter(
    ([, meta]) => meta.section === "Workspace"
  );
    ...
    <div className="space-y-12">
      ...
      <section className="pt-2">
        ...
        <div className="flex justify-end pt-10 mt-8 border-t border-zinc-100">
          <Button onClick={() => showToast("프로필이 저장되었습니다.")}>
            변경 사항 저장
          </Button>
        </div>
      </section>
  ...
  return (
    <div className="space-y-12">
      ...
      <section className="pb-4 space-y-6">
        ...
        <div className="flex justify-end pt-10 mt-8 border-t border-zinc-100">
          <Button onClick={() => showToast("설정이 업데이트되었습니다.")}>
            저장
          </Button>
        </div>
      </section>
    ...
    <div className="space-y-10">
      ...
      <SettingsGroup title="이메일 알림">
        <SettingsRow
          label="주간 리포트"
          description={
            "지난주 활동 요약과 주요 통계를 주 1회 이메일로 받아봅니다."
          }
        >
          <ToggleItem checked />
        </SettingsRow>
        ...
        <SettingsRow
          label="제품 업데이트"
          description={
            "새로운 기능 출시, 개선 사항, 주요 공지사항을 이메일로 받아봅니다."
          }
        >
          <ToggleItem />
        </SettingsRow>
      ...
      <SettingsGroup title="푸시 알림">
        ...
        <SettingsRow
          label="모바일 푸시"
          description="모바일 앱에서 푸시 알림을 받습니다."
        >
          <ToggleItem checked />
        </SettingsRow>
    ...
    <div className="space-y-8">
      <Section title="워크스페이스 정보">
        <div className="space-y-4">
          ...
          <Input
            label="워크스페이스 URL"
            defaultValue="acme-corp.myapp.com"
            prefix="https://"
          />
        </div>
      </Section>
      ...
      <div className="flex justify-end pt-4">
        <Button onClick={() => showToast("설정이 저장되었습니다.")}>
          저장
        </Button>
      </div>
    </div>
...
function ScheduleTab({ showToast }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-end pt-4">
        <Button onClick={() => showToast("작업 일정이 저장되었습니다.")}>
          저장
        </Button>
      </div>
    </div>
  ...
  return (
    <div className="space-y-10">
      ...
      <SettingsGroup title="계정보안">
        <SettingsRow
          label="이메일"
          description="로그인 및 알림에 사용되는 이메일입니다."
        >
          <span className="text-sm text-zinc-700 mr-3">
            kims2258@gmail.com
          </span>
          <Button variant="secondary" size="sm">
            이메일 변경
        ...
        <SettingsRow
          label="2단계 인증"
          description="로그인 단계에서 계정 보안 방식을 추가하세요."
        >
          <Button variant="secondary" size="sm">
            인증 방법 추가
          </Button>
        ...
        <SettingsRow
          label="패스키"
          description="기기 생체 인식 인증으로 안전하게 로그인하세요."
        >
          <Button variant="secondary" size="sm">
            패스키 추가
          </Button>
      ...
      <SettingsGroup title="지원">
        ...
        <div className="pt-6 text-xs text-red-500 cursor-pointer hover:underline">
          내 계정 삭제
        </div>
      </SettingsGroup>

      <div className="flex justify-end pt-4">
        <Button onClick={() => showToast("보안 설정이 저장되었습니다.")}>
          저장
        </Button>
      </div>
    </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-end pt-2">
        <Button onClick={() => showToast("청구 설정이 저장되었습니다.")}>
          저장
        </Button>
      </div>
    </div>
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-2">
        <SectionTitle
          title="멤버 관리"
          desc={`${members.length}명의 멤버가 있습니다.`}
        />
        <Button
          size="sm"
...
function Input({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {description && (
        <p className="text-[11px] text-zinc-500 mt-1 mb-3">{description}</p>
      )}
    </div>
  );
}
...
function Button({
  ...
  const variants = {
    primary:
      "bg-zinc-900 text-white hover:bg-black shadow-sm focus:ring-zinc-900 hover:shadow-md",
    secondary:
...
function SettingsGroup({ title, children }) {
  return (
    <section className="pt-8 first:pt-0">
      <h3 className="text-xs font-semibold text-zinc-500 tracking-wide mb-3">
        {title}
      </h3>
